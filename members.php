    ...
    <div class="container-fluid">
        <div class="container-bg">
            ...
            <div class="col-md-12" style='background-color: white'>
                ...
                echo '<table style="border: 1px solid black;>"';
                echo '<tr> <td style="border: 1px solid black;>"> date </td> <td style="border: 1px solid black;>"> time </td> <td style="border: 1px solid black;>"> requestID </td>  <td style="border: 1px solid black;>"> currentFloor </td><td style="border: 1px solid black;>"> requestedFloor </td> <td style="border: 1px solid black;>"> otherInfo </td>  </tr>';
